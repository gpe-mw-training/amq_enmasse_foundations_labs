...
var connection = require('rhea').connect({'port':args.port,host:"messaging-enmasse16rc4project.apps.dev37.openshift.opentlc.com",username:'kcuser', password:'kcpassword',transport:'tls',rejectUnauthorized:false});
