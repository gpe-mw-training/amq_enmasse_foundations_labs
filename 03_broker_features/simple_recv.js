...
container.connect({port:args.port,host:"messaging-15c065e-amq-online-infra.apps.cluster-76bb.76bb.example.opentlc.com", username:'userb', password:'password', transport:'tls',rejectUnauthorized:false}).open_receiver({source:args.node, snd_settle_mode:0});
